...
export default interface RoomPrototype{
  ...
  eventListeners : {event: keyof RoomEvents, listener: (...args: any[]) => void}[];
...
//   on: (event: keyof RoomEvents, listener : (...args : EventEmitter<RoomEvents>) => void) => void;
//   off: (event: keyof RoomEvents, listener : Function) => void;
}
